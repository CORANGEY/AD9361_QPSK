...
#
# Script generated by Vivado on Wed Apr 22 15:52:26 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ipath_generator.sh
...
#
# Usage        : ipath_generator.sh
#                ipath_generator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ipath_generator.sh [-rerun]
#                ipath_generator.sh [-reset_run]
#                ipath_generator.sh [-clean]
#                ipath_generator.sh [-reset_log]
#                ipath_generator.sh [-help]
#
...
# script info
echo -e "ipath_generator.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ipath_generator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ipath_generator xil_defaultlib.ipath_generator xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ipath_generator -key {Behavioral:sim_1:Functional:ipath_generator} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ipath_generator.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ipath_generator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ipath_generator.sh [-help]\n\
Usage: ipath_generator.sh [-step]\n\
Usage: ipath_generator.sh [-lib_map_path]\n\
Usage: ipath_generator.sh [-rerun]\n\
Usage: ipath_generator.sh [-reset_run]\n\
Usage: ipath_generator.sh [-clean]\n\
Usage: ipath_generator.sh [-reset_log]\n\
Usage: ipath_generator.sh [-keep_index]\n\
Usage: ipath_generator.sh [-noclean_files]\n\n\
