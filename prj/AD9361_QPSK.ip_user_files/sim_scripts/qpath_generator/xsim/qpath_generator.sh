...
#
# Script generated by Vivado on Thu Apr 23 21:51:53 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : qpath_generator.sh
...
#
# Usage        : qpath_generator.sh
#                qpath_generator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                qpath_generator.sh [-rerun]
#                qpath_generator.sh [-reset_run]
#                qpath_generator.sh [-clean]
#                qpath_generator.sh [-reset_log]
#                qpath_generator.sh [-help]
#
...
export RDI_DATADIR="E:/ProgramFiles/Xilinx/2025.2/Vivado/data"
...
# script info
echo -e "qpath_generator.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./qpath_generator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot qpath_generator xil_defaultlib.qpath_generator xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim qpath_generator -key {Behavioral:sim_1:Functional:qpath_generator} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/ProgramFiles/Xilinx/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb qpath_generator.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./qpath_generator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: qpath_generator.sh [-help]\n\
Usage: qpath_generator.sh [-step]\n\
Usage: qpath_generator.sh [-lib_map_path]\n\
Usage: qpath_generator.sh [-rerun]\n\
Usage: qpath_generator.sh [-reset_run]\n\
Usage: qpath_generator.sh [-clean]\n\
Usage: qpath_generator.sh [-reset_log]\n\
Usage: qpath_generator.sh [-keep_index]\n\
Usage: qpath_generator.sh [-noclean_files]\n\n\
